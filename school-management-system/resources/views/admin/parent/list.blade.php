      ...
      @include('_message')
            ...
            <div class="card card-info">
              <div class="card-header">
                <h6 class="card-title">Search Parent</h6>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="get" action="">
                ...
                <div class="form-group col-md-3">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <a href="{{ url('admin/parent/list')}}"  type="submit" class="btn btn-success" style="margin-top:30px;">Clear</a>
              ...
              <div class="card-body" style="overflow:auto;">
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td><a href="{{url('admin/parent/edit',$value->id)}}" class="btn btn-info">Edit</a></td>
                    <td><a href="{{url('admin/parent/delete',$value->id)}}"class="btn btn-danger">Delete</a></td>
                    <td><a href="{{url('admin/parent/my-children',$value->id)}}"class="btn btn-info">My Children</a></td>
                  </tr>
                    @endforeach
                  </tbody>
                </table>
